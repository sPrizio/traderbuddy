package com.traderbuddyv2.core.validation;
...
import com.traderbuddyv2.core.exceptions.validation.JsonMissingPropertyException;
import com.traderbuddyv2.core.exceptions.validation.NoResultFoundException;
import com.traderbuddyv2.core.exceptions.validation.NonUniqueItemFoundException;
...
public class GenericValidator {
    ...
    public static void validateAcceptableYear(final int year, final String message, final Object... values) {
        ...
        if (year > CoreConstants.MAX_CALENDAR_YEAR) {
            throw new IllegalArgumentException(String.format("The given year %s was higher than the maximum allowable %d", year, CoreConstants.MAX_CALENDAR_YEAR));
        }
    }
